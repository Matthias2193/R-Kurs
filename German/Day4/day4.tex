...
\begin{frame}[fragile]{lapply()}
	lapply() führt eine Funktion auf jedes Element eines Data Frames, einer Matrix, eines Vektors oder einer Liste aus. Das 'l' \text{in} lapply() steht dabei für 'list' \text{und} bezieht sich darauf, dass lapply() immer eine Liste zurück gibt.1
	\begin{itemize}
