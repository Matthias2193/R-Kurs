...
\begin{frame}[fragile]{Scatterplot}
	\begin{itemize}
		\item \verb+plot(data$AufKGr, data$AufKGew)+
	\end{itemize}
...
\begin{frame}[fragile]{Boxplot}
	\begin{itemize}
		\item \verb+boxplot(AufKGr ~ VAR0003, data)+
	\end{itemize}
...
\begin{frame}[fragile]{Histogram mit Density}
	\begin{itemize}
		\item \verb+hist(data$AufKGew, probability = T) + \\ \verb +lines(density(data$AufKGew))+
	\end{itemize}
...
\begin{frame}[fragile]{Beschriftungen für Plots}
	...
	\begin{itemize}
		\item Beispiel: \verb+plot(data$AufKGr, data$AufKGew, xlab="Größe,"+
